...
/**
 * @authors: Laura and Sterling Loughmiller
 * 
 *           This interface represents a finite automaton (FA).
 *           It provides methods for adding states/symbols, setting start/final
 *           states,
 *           checking if a state is start or final, getting a state by name and
 *           simulating the FA.
 */
